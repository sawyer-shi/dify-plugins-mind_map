...
# -*- coding: utf-8 -*-
"""
Horizontal Layout Mind Map Tool with Watermark
Generates optimized left-to-right mind maps from Markdown text with Watermark
"""
...
def get_tool():
    return MindMapHorizontalWatermarkTool
